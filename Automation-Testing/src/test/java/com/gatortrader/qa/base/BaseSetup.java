...
public class BaseSetup {
    ...
    public BaseSetup(){
        try {
            ...
            System.out.println(properties.get("app.ui.url"));
        }catch(IOException ex){

        }
    }
    public void openBrowser(){
        String browserType = this.properties.getProperty("app.browser.type");
        boolean isHeadless = Boolean.parseBoolean(this.properties.getProperty("app.browser.headless"));
        ...
        String url = this.properties.getProperty("app.ui.url");
        driver.get(url);
